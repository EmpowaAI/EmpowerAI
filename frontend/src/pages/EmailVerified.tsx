        ...
        <div className="bg-card/80 dark:bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl p-8 sm:p-10 text-center animate-slide-up">
          ...
          {!isLoading && isSuccess && (
            <div className="space-y-6">
              ...
              <Link
                to="/login"
                className="inline-block w-full text-center px-4 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors font-semibold"
              >
                Go to Login
              </Link>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link
                    to="/signup"
                    className="flex-1 text-center px-4 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors font-semibold"
                  >
                    Sign up again
                  </Link>
                  <Link
                    to="/login"
                    className="flex-1 text-center px-4 py-3 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/90 transition-colors font-semibold"
                  >
                    Go to Login
                  </Link>
                </div>
