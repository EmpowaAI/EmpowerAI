          ...
          <div className="bg-card/80 dark:bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl p-6 sm:p-7 md:p-9 hover:shadow-3xl transition-all duration-300">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                ...
                <Link to="/signup" className="text-slate-700 dark:text-slate-300 hover:text-primary dark:hover:text-primary font-semibold hover:underline transition-all duration-200 relative group">
                  Sign up
