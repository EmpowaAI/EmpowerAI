    ...
    <div className="h-screen bg-background flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        <header className="h-16 border-b border-border bg-card/90 backdrop-blur-md flex items-center px-4 md:px-6 gap-3 flex-shrink-0 sticky top-0 z-30">
          <button
            className="lg:hidden text-foreground hover:text-primary p-2 -ml-1 hover:bg-muted rounded-lg transition-colors active:scale-95"
          ...
          {isSubPage && (
            <button
              ...
              className="flex items-center gap-2 text-foreground hover:text-primary transition-colors px-3 py-2 hover:bg-muted rounded-lg"
            >
