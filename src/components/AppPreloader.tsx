    ...
    >
      <div className="flex flex-col items-center gap-5 animate-scale-in">
        ...
        <div className="text-center">
          <p className="font-display text-2xl font-semibold text-foreground">EmpowAI</p>
          <p className="mt-1 text-sm font-medium text-muted-foreground">Preparing your career intelligence</p>
        </div>
      </div>
    </div>
  );
